...
import smart_brain from "../../../../assets/images/portfolio/smart_brain.png";
...
import story from "../../../../assets/images/portfolio/story.png";
import vidjot from "../../../../assets/images/portfolio/vidjot.png";
...
const Portfoliocollapse = () => {
  return (
    <div id="portfolioCollapse" className="collapse" data-parent="#accordion">
      ...
      <div className="card-second-background card">
        <div className="card-body rounded-0 pt-5">
          ...
          <div className="imageFlex">
            ...
            <div className="imageFlex-Card">
              <div className="card text-center">
                <a href={story} data-toggle="modal" data-target="#story_modal">
                  <img className="campImage" src={story} alt="Robofriends" />
                </a>
                <div className="card-body">
                  <h4 className="card-title"><a href="https://obscure-headland-61456.herokuapp.com/" target="_blank" rel="noopener noreferrer">Story</a></h4>
                  <p>Story book where you can write your private and public stories</p>
                </div>
              </div>
            </div>
            <div className="imageFlex-Card">
            ...
            <div className="imageFlex-Card">
              <div className="card text-center">
                <a href={vidjot} data-toggle="modal" data-target="#vidjot_modal">
                  <img className="campImage" src={vidjot} alt="Color Game" />
                </a>
                <div className="card-body">
                  <h4 className="card-title"><a href="https://github.com/bipinstha7/vidjot" target="_blank" rel="noopener noreferrer">VidJot</a></h4>
                  <p>Write your ideas. Can't remeber? VidJot is here to write you instant ideas</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="modal fade" id="story_modal" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div className="modal-dialog modal-lg" role="document">
          <img className="campImage_full" src={story} alt="Story" />
        </div>
      </div>
      ...
      <div className="modal fade" id="vidjot_modal" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div className="modal-dialog modal-lg" role="document">
          <img className="campImage_full" src={vidjot} alt="VidJot" />
        </div>
      </div>
    </div>
  );
